...
class HDFist:HDWeaponGrabber replaces Fist{
	...
	override string gethelptext(){
		LocalizeHelp();
		return
		WEPHELP_FIRE..StringTable.Localize("$FISTWH_FIRE")
		..WEPHELP_ALTFIRE..StringTable.Localize("$FISTWH_ALTFIRE")
		..WEPHELP_RELOAD..StringTable.Localize("$FISTWH_RELOAD")
		..WEPHELP_FIREMODE..StringTable.Localize("$FISTWH_FMODE")
		..WEPHELP_UNLOAD..StringTable.Localize("$FISTWH_UNLOAD")
		..WEPHELP_ZOOM.."+"..WEPHELP_SPEED.."+"..WEPHELP_USE..StringTable.Localize("$FISTWH_ZPSPED")
		..WEPHELP_ZOOM.."+"..WEPHELP_DROP..StringTable.Localize("$FISTWH_ZPDROP")
		;
	}
