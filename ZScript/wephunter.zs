...
class Hunter:HDShotgun{
	...
	override string gethelptext(){
		LocalizeHelp();
		return
		WEPHELP_FIRE..StringTable.Localize("$SHOOT_CH")..weaponstatus[HUNTS_CHOKE]..")\n"
		..WEPHELP_ALTFIRE..StringTable.Localize("$PUMP")
		..WEPHELP_RELOAD..StringTable.Localize("$SHTG_REL1")
		..WEPHELP_ALTRELOAD..StringTable.Localize("$SHTG_REL2")
		..(weaponstatus[0]&HUNTF_EXPORT?"":(WEPHELP_FIREMODE..StringTable.Localize("$SHTG_FMODE")..(weaponstatus[0]&HUNTF_CANFULLAUTO?"/Auto":"").."\n"))
		..WEPHELP_FIREMODE.."+"..WEPHELP_RELOAD..StringTable.Localize("$SHTG_SIDE")
		..WEPHELP_USE.."+"..WEPHELP_UNLOAD..StringTable.Localize("$SHTG_STEAL")
