...
class HDRL:HDWeapon{
	...
	override string gethelptext(){
		...
		return
		WEPHELP_FIRESHOOT
		..WEPHELP_ALTFIRE.."  "..(weaponstatus[0]&RLF_GRENADEMODE?StringTable.Localize("$RLWH_ROCK"):StringTable.Localize("$RLWH_GREN"))..StringTable.Localize("$RLWH_MODE")
		..(weaponstatus[RLS_CHAMBER]>1?(
			WEPHELP_ALTRELOAD..StringTable.Localize("$RLWH_OR")..WEPHELP_RELOAD..StringTable.Localize("$RLWH_REMOVHEAT")
		):(
			WEPHELP_ALTRELOAD..StringTable.Localize("$RLWH_LOAD")
			..WEPHELP_RELOADRELOAD
		))
		..WEPHELP_FIREMODE.."+"..WEPHELP_UPDOWN..StringTable.Localize("$RLWH_AIRBURST")
