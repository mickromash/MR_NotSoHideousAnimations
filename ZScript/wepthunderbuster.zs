...
class ThunderBuster:HDCellWeapon{
	...
	override string gethelptext(){
		...
		return
		WEPHELP_FIRESHOOT
		..WEPHELP_ALTFIRE..StringTable.Localize("$THBWH_SWITCH")..(weaponstatus[0]&TBF_ALT?StringTable.Localize("$THBWH_DETONATOR"):StringTable.Localize("$THBWH_SCATTERSHOT"))..StringTable.Localize("$THBWH_MODE")
		..WEPHELP_RELOADRELOAD
		..WEPHELP_UNLOADUNLOAD
		..WEPHELP_ALTRELOAD..StringTable.Localize("$THBWH_ALTRELOAD")
		;
	}
	int rangefinder;
