...
class BFG9K:HDCellWeapon replaces BFG9000{
	...
	override string gethelptext(){
		LocalizeHelp();
		return
		WEPHELP_FIRE..StringTable.Localize("$BFGWH_FIRE")
		..WEPHELP_ALTFIRE..StringTable.Localize("$BFGWH_ALTFIRE")
		..WEPHELP_RELOAD..StringTable.Localize("$BFGWH_RELOAD")
		..WEPHELP_ALTRELOAD..StringTable.Localize("$BFGWH_ALTRELOAD")
		..WEPHELP_UNLOADUNLOAD
		..WEPHELP_USE.."+"..WEPHELP_UNLOAD..StringTable.Localize("$BFGWH_USEPUNL")
		;
	}
