...
class HDGrenadeThrower:HDWeapon{
	...
	override string gethelptext(){
		...
		WEPHELP_FIRE..StringTable.Localize("$GRENWH_FIRE1")..WEPHELP_RGCOL..")";
		return
		WEPHELP_FIRE..StringTable.Localize("$GRENWH_FIRE2")
		..WEPHELP_ALTFIRE..StringTable.Localize("$GRENWH_ALTFIRE")
		..WEPHELP_RELOAD..StringTable.Localize("$GRENWH_RELOAD")
		..WEPHELP_ZOOM..StringTable.Localize("$GRENWH_ZOOM")
		;
	}
